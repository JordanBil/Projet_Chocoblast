                ...
                if(!empty($mail) AND !empty($password)){
                    ...
                    if($data){
                        ...
                        //Test si le mot de passe est incorrect
                            ...
                            $msg = "Les informations de connexion sont invalides 1";
                        }
                    }
                    //Test si le compte n'existe pas
                    else{
                        $msg = "Les informations de connexion sont invalides 2";
                    }
                }
                //Test les champs sont vides
                else{
                    $msg = "Veuillez remplir tous les champs de formulaire 3";
                } 
            }
